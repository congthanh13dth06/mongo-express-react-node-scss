...
import InputAccountHtml from '../../../../../ui/public/register/new/inputAccount/inputAccount.html'
...
export default class InputAccountComponent extends Component {
  ...
  componentDidMount() {
    ...
    try {
      ...
      ui.isShowBtn = false
      const data = AppServices.services.cacheLayout.get(match.url, viewNew.inputAccount)
  ...
  handleResponseCode(){
    ...
    try {
      ...
      AppServices.services.cacheLayout.set(match.url, model, view.new, viewNew.inputAccount)
