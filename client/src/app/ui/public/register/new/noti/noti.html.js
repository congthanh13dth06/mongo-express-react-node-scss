        ...
        <div className={Style.REGISTER} style={{"minHeight": "600px"}}>
          <div className={Style.FORM_SUCCESS}>
            ...
            <div className={Style.DESCRIPTION}>
              <p>{appServices.services.localize.getLocalize(localizeKey.REGISTER_VALIDATION_ACCOUNT_INFO_RECIEVED_ONE)}</p>
              <p>{appServices.services.localize.getLocalize(localizeKey.REGISTER_VALIDATION_ACCOUNT_INFO_RECIEVED_TWO)}</p>
            </div>
